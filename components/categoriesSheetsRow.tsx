                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell>
                                            <Chip
                                                key={s.id}
                                                label={refSheetToType(
                                                    s.reference
                                                )}
                                                className={clsx(classes.chip, {
                                                    [classes.chipConnaissance]:
                                                        type ===
                                                        'Connaissances',
                                                    [classes.chipProcedure]:
                                                        type === 'Procédures',
                                                    [classes.chipTechnique]:
                                                        type === 'Techniques',
                                                })}
                                            />
                                        </TableCell>
                                        <TableCell className={classes.hideSm}>
                                            PSE {s.level}
                                        </TableCell>
