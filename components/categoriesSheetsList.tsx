...
export default function CategoriesSheetsList(props: IProps) {
    ...
    const availableUpdateDate = [
        ...new Set(props.sheetsLight.map((s) => s.updatedDate)),
    ];
    return (
        <>
            <main
            ...
            >
                ...
                <div className={classes.filtersHeader}>
                    <SearchInput
                        searchField={filterSheet}
                        setSearchField={setFilterSheet}
                    />

                    <LevelSelect
                        levelSelected={filterLevel}
                        setLevelSelected={setFilterLevel}
                    />
                    <DateSelect
                        dates={availableUpdateDate.map((d) =>
                            new Date(d).getTime()
                        )}
                        dateSelected={filterDate}
                        setDateSelected={setFilterDate}
                    />
                </div>
                    ...
                    <CategoriesSheetsRow
                        ...
                        sheetsLight={
                            props.sheetsLight
                                ...
                                .filter(
                                    (s) =>
                                        new Date(s.updatedDate).getTime() ===
