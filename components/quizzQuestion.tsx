    ...
    return (
        <div className={classes.root}>
            <FormControl component="fieldset" className={classes.formControl}>
                ...
                <FormHelperText>
                    PSE{props.question.level} - Difficulté{' '}
                ...
                <FormGroup>
                    {[1, 2, 3].map((idx) => (
                        <QuizzCheckboxAnswer
                            ...
                            right={
                                props.completed &&
                                answersOk(props.question).includes(idx)
                            }
                            onChange={() =>
                                props.handleChange(props.question.id, idx)
                            }
                        />
                    ))}
                </FormGroup>
                {props.completed && props.question.explaination && (
                    <QuizzExplaination
                        correct={
                            computeScore([props.question], [props.answers]) ===
                            100
                        }
