...
import {
    QuizzQuestion,
    QuizzQuestionFull,
} from '../lib/interfaces/quizz-question.interface';
import {
    QuizzAnswer,
    QuizzAnswerCreation,
} from '../lib/interfaces/quizz-answer.interface';
...
export { fetchQuizzAnswers, fetchQuizzQuestions, insertQuizzAnswer };
